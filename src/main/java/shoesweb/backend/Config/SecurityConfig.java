package shoesweb.backend.Config;
...
import shoesweb.backend.Filter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf().disable()
                ...
                .requestMatchers("/api/welcome", "/api/addNewUser", "/api/generateToken","api/v1/**").permitAll()
                .and()
